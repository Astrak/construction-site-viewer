...
import { NoBlending, Vector2, Color, OrthographicCamera, CustomBlending, DstColorFactor, DstAlphaFactor, ZeroFactor, AddEquation, Scene, Mesh, PlaneGeometry, LinearFilter, RGBAFormat, WebGLRenderTarget, NearestFilter, MeshDepthMaterial, DepthTexture, UnsignedShortType, RGBADepthPacking, MeshNormalMaterial, ShaderMaterial, UniformsUtils } from 'three';
import { Pass } from './EffectComposer';
import ShaderPass from './ShaderPass';
import CopyShader from './CopyShader';
import SAOShader from './SAOShader';
import { DepthLimitedBlurShader, BlurShaderUtils } from './DepthLimitedBlurShader';
import UnpackDepthRGBAShader from './UnpackDepthRGBAShader';

function SAOPass ( scene, camera, depthTexture, useNormals, resolution ) {
