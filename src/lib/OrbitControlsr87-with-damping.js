...
import { EventDispatcher, Vector3, Vector2, Quaternion, Spherical, PerspectiveCamera, OrthographicCamera, MOUSE } from 'three';
...
function OrbitControls ( object, domElement ) {
	...
	function handleMouseMoveRotate( event ) {
		...
		rotateLeft( 2 * Math.PI * rotateDelta.x / width * scope.rotateSpeed );

		// rotating up and down along whole screen attempts to go 360, but limited to 180
		rotateUp( 2 * Math.PI * rotateDelta.y / height * scope.rotateSpeed );
